  ...
  return (
       <Fragment>
        <div style={{color:"white",marginBottom:'30px'}}>
            ...
            <button type="button" className="btn btn-danger float-end" data-bs-toggle="modal" data-bs-target="#exampleModal" style={{margin:"0px 10px"}}>
                    Xoa het
            </button>
            <button type="button" className="btn btn-success float-end" data-bs-toggle="modal" data-bs-target="#BinModal">
                    Thung rac
                    <span className="badge bg-primary" style={{marginLeft:"10px" }}>{lengthBin()}</span>
            </button>
            ...
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="float-center" id="exampleModalLabel">Thung rac</h5>
                    </div>
                    <div className="modal-body">
                            {jobs.map((job,i)=>(
                                <div key={i}>
